                  ...
                  >
                    ...
                    >
                      ...
                      <button
                        ...
                        onClick={() =>
                          updateConfig((c) => {
                            c.routing.bindings.splice(idx, 1);
                            return c;
                          })
                        }
                      >
                    ...
                    <TextInput
                      ...
                      onChange={(v) =>
                        updateConfig((c) => {
                          c.routing.bindings[idx].agent_id = v;
                          return c;
                        })
                      }
                      placeholder="default"
                    ...
                    <TextInput
                      ...
                      onChange={(v) =>
                        updateConfig((c) => {
                          c.routing.bindings[idx].match_channel =
                            v || undefined;
                          return c;
                        })
                      }
                    ...
                    <TextInput
                      ...
                      onChange={(v) =>
                        updateConfig((c) => {
                          c.routing.bindings[idx].match_account =
                            v || undefined;
                          return c;
                        })
                      }
                    ...
                    <TextInput
                      ...
                      onChange={(v) =>
                        updateConfig((c) => {
                          c.routing.bindings[idx].match_peer =
                            v || undefined;
                          return c;
                        })
                      }
                    ...
                    <TextInput
                      ...
                      onChange={(v) =>
                        updateConfig((c) => {
                          c.routing.bindings[idx].match_guild =
                            v || undefined;
                          return c;
                        })
                      }
